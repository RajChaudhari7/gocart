        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <p className="mt-5 text-sm text-slate-600 max-w-sm leading-relaxed">
              Smart gadgets and premium accessories for modern users.
            </p>
            ...
            <div className="flex gap-3 mt-6">
              {socials.map((s, i) => (
                <motion.a
                  ...
                  className="w-10 h-10 rounded-full bg-green-600 text-white flex items-center justify-center shadow-md hover:shadow-lg transition"
                >
          ...
          {/* Products */}
          <div>
            <h4 className="font-semibold mb-4 text-slate-700">Products</h4>
          ...
          {/* Company */}
          <div>
            <h4 className="font-semibold mb-4 text-slate-700">Company</h4>
            <ul className="space-y-2 text-sm text-slate-600">
          ...
          {/* Contact */}
          <div>
            <h4 className="font-semibold mb-4 text-slate-700">Contact</h4>
